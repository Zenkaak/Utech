...
import { LayoutDashboard, Send, ClipboardList, Search, Settings, MessageCircle } from 'lucide-react';
...
export function BottomNav({ activePage, onNavigate, errorCount = 0, chatUnread = 0 }: BottomNavProps) {
  return (
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center gap-0.5">
              ...
              >
                ...
                {badge && errorCount > 0 && (
                  <span className="absolute -top-1 -right-1.5 min-w-[14px] h-3.5 px-0.5 rounded-full bg-amber-500 border border-background flex items-center justify-center text-[8px] font-bold text-white leading-none">
